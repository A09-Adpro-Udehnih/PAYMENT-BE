...
// Hapus import: import org.springframework.security.access.prepost.PreAuthorize;
import org.springframework.web.bind.annotation.*; 
 
import java.util.List; 
 
@RestController 
@RequestMapping("/admin/payments") // Ubah dari /api/admin/payments menjadi /admin/payments
@RequiredArgsConstructor 
// Hapus anotasi @PreAuthorize("hasRole('ADMIN')")
